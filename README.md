...
| **Bimo Alfarizy Lukman** | 102022330069 | **Documentation & QA Engineer** | • Postman collection lengkap (29 endpoints)<br>• Testing manual & automated (test scripts)<br>• Screenshot dokumentasi:<br>&nbsp;&nbsp;◦ Swagger UI (4 services)<br>&nbsp;&nbsp;◦ Postman requests & responses<br>&nbsp;&nbsp;◦ Health check endpoints<br>• Bug reporting & regression testing<br>• User Service: CRUD User, Autentikasi (Login/JWT), Seed Admin|
